...
extern unsigned int deal_cmd,flow_l,flow_y,T_chongxi;

extern unsigned int  sum_viuv_time ,sum_viuv_flow;
extern unsigned int  sum_flow , value_flow , yu_sum_flow ;
extern unsigned int  sum_time , value_time, yu_sum_time ;
